...
if (!DevExpress.MOD_WIDGETS) {
        ...
        ui.registerComponent("dxSlider", ui.Widget.inherit({
            ...
            _handleStart: function(args) {
                ...
                if (instance._eventHelper.needSkipEvent(e))
                    return;
                this._currentRatio = (this._eventHelper.eventX(e) - this._$bar.offset().left) / this._$bar.width();
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxRangeSlider", ui.dxSlider.inherit({
            ...
            _handleStart: function(args) {
                var e = args.jQueryEvent;
                var eventOffsetX = this._eventHelper.eventX(e) - this._$bar.offset().left,
            ...
            _handleSwipeUpdate: function(e) {
                if (Math.abs(this.option("start") - this.option("end")) === 0 && this._$handlersDistance < this._$handle.outerWidth()) {
                    ...
                    this._capturedHandle = e.offset <= 0 ? this._$handle : this._$handleRight;
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxLookup", ui.Widget.inherit({
            ...
            _renderField: function() {
                ...
                this._$field = $("<div/>").addClass(LOOKUP_FIELD_CLASS).appendTo(this._element()).on(this._eventHelper.eventName("click"), function(e) {
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxActionSheet", ui.CollectionContainerWidget.inherit({
            ...
            _render: function() {
                ...
                this._popupTitle = $(POPUP_TITLE_SELECTOR, this._element());
            ...
            _togglePopupTitle: function(visible) {
                this._popupTitle.toggle(visible);
                this._popup._element().toggleClass(ACTION_SHEET_WITHOUT_TITLE_CLASS, !visible)
            },
            _optionChanged: function(name, value) {
                switch (name) {
                    case"visible":
    ...
    (function($, DX) {
        ...
        DX.framework.Application = Class.inherit({
            ...
            _onNavigated: function(args) {
                var self = this;
                var viewInfo = self._acquireView(args.item);
                this._setCurrentView(viewInfo, args.options.direction).done(function() {
